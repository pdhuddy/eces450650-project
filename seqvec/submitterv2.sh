...
pip install --user  seqvec

seqvec -i /ifs/groups/eces450650Grp/ECES450650_SP22/projectE/seqvec/batch-0-cap.fasta -o /ifs/groups/eces450650Grp/ECES450650_SP22/projectE/seqvec/seqvec.npz --model /ifs/groups/eces450650Grp/ECES450650_SP22/projectE/model
